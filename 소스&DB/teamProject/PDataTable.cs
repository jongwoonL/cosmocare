...
{
    public partial class PDataTable : Form
    {
        ...
        public PDataTable()
        {
            ...
            Utils.reScreen(dataGridView1, "PData", Main.digit, progressBar1);
        }
        ...
        private void submit_Click(object sender, EventArgs e)
        {
            ...
            {
                Utils.reScreen(dataGridView1, "PData", string.Join(" ", gnb.conditions), Main.digit, progressBar1);
            }
        }
